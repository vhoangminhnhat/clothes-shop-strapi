...
export interface ApiClotheClothe extends Schema.CollectionType {
...
export interface ApiConfigurationConfiguration extends Schema.SingleType {
  ...
  attributes: {
    ...
    paymentMethods: Attribute.Enumeration<['cash', 'momo', 'banking']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiTransactionTransaction extends Schema.CollectionType {
  ...
  attributes: {
    quantity: Attribute.Integer;
    totals: Attribute.Integer;
    user: Attribute.Relation<
      'api::transaction.transaction',
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    paymentMethod: Attribute.Enumeration<['cash', 'banking', 'momo']>;
